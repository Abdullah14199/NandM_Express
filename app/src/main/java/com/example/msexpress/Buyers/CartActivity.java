...
import com.example.msexpress.Model.Cart;
import com.example.msexpress.Prevalent.Prevalent;
import com.example.msexpress.R;
import com.example.msexpress.ViewHolder.CartViewHolder;
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
           ...
           if (dataSnapshot.exists())
           {
               ...
               if (shippingState.equals("shipped"))
               {
                   ...
                   txtMsg1.setText("Congratulations , your final order has been shipped successfully.Soon you will received your order at your door stop.");
