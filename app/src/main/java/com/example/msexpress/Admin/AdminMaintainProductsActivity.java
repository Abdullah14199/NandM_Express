...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prodcutsRef = FirebaseDatabase.getInstance().getReference().child("Products").child(productID);
    ...
    {
        prodcutsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    private void applyChanges()
    {
        ...
        }else if (pDescription.equals(""))
        {
            ...
            prodcutsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
    ...
    private void displaySpecificProductInfo() {
        prodcutsRef.addValueEventListener(new ValueEventListener() {
            @Override
